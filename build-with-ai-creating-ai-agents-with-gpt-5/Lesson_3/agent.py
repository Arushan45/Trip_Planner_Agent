...
SYSTEM_INSTRUCTIONS = (
    "You are Trip Coach. You help travelers plan activities and check real-time weather first. "
    "Be brief. Use short bullet points. Make sure recommendations fit solo travelers."
)
...
def main() -> None:
    ...
    user_prompt = f"""Headed to {city} today. What weather should I expect and 
